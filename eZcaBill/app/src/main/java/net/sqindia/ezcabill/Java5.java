 ...
 */
public class Java5 extends BaseAdapter {
   ...
   // Typeface tf = Typeface.createFromFile("fonts/montserrat.ttf");
    ...
    public Java5(Context c1, ArrayList<Java1> list) {
        this.c1 = c1;
        arrayList = list;
    ...
    public View getView(int position, View v2, ViewGroup parent) {
        ...
        v2 = inflat.inflate(R.layout.seperate_unpaid,null);

        t1 = (TextView) v2.findViewById(R.id.textview1);
        t2 = (TextView) v2.findViewById(R.id.textview2);
        t3 = (TextView) v2.findViewById(R.id.textview3);
      /*  t4 = (TextView) v2.findViewById(R.id.textview4);
        t5 = (TextView) v2.findViewById(R.id.textview5);*/
