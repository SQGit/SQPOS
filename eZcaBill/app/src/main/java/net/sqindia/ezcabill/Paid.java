 ...
 */
public class Paid extends Activity{

    private static final String SELECT_SQL = "SELECT * FROM persons where payment = 'paid'";

    private SQLiteDatabase db;

    TextView txt_id,txt_name,txt_no,txt_payment;
    private Cursor c;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.paid_listView);
        txt_id = (TextView) findViewById(R.id.t1);
        txt_name = (TextView) findViewById(R.id.t2);
        txt_no = (TextView) findViewById(R.id.t3);
    ...
    protected void showRecords() {
        ...
        Java4 adapter1 = new Java4(Paid.this,lv1);
...
*/
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(Paid.this,DashBoard.class);
        startActivity(i);
        finish();
