 ...
 */
public class Java33 extends BaseAdapter {

    Context c2;
    ArrayList<Java11> arrayList2;
    TextView t1, t, t2, t3, t4, t5, t6;
    ...
    public Java33(Context c1, ArrayList<Java11> lists) {
        this.c2 = c1;
        arrayList2 = lists;
    ...
    public View getView(int position, View v3, ViewGroup parent) {
        ...
        v3 = inflat.inflate(R.layout.aaaaab, null);
