 ...
 */
public class Printerconfig extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.printerconfig);
        ...
        if (mBluetoothAdapter == null) {
            ...
            mPrintTextBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View arg0) {
                    InputTextDialog dialog = new InputTextDialog(Printerconfig.this, new InputTextDialog.OnOkClickListener() {
                        @Override
